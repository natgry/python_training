...
class test_add_contact(unittest.TestCase):
    ...
    def create_contact(self, wd):
        ...
        wd.find_element_by_name("lastname").send_keys("gryaznova")
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys("natgry")
        wd.find_element_by_name("title").click()
        wd.find_element_by_name("title").clear()
        wd.find_element_by_name("title").send_keys("sfe")
        wd.find_element_by_name("company").click()
        wd.find_element_by_name("company").clear()
        wd.find_element_by_name("company").send_keys("emc")
        ...
        wd.find_element_by_name("email").send_keys("natgry@yandex.ru")
